...
function game.draw()
	...
	local info = "score:" .. game.score .. " ammo:" .. game.ammo
	love.graphics.printf(info, 0, 0, love.graphics.getWidth(), "center")

	if debug then 
		local debugInfo = "enemies: " .. #game.enemies ..
						"\nbullets: " .. #game.bullets ..
						"\nenemy_rate: " .. game.enemy_rate ..
						"\nFPS: " .. love.timer.getFPS()
		love.graphics.print(debugInfo, 0, 14 * scale)
	end
